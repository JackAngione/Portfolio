...
function Photography() {
  ...
  useEffect(() => {
    fetch(
      `https://api.flickr.com/services/rest/?method=flickr.people.getPublicPhotos&api_key=${flickrKey}&user_id=136018663@N05&format=json&nojsoncallback=1`,
    )
        ...
        let photoArray = data.photos.photo.map((pic) => {
          ...
          return (
            <div className="imageDiv">
              <a
                href={`https://www.flickr.com/photos/jackangione/${pic.id}`}
                target="_blank"
  ...
  return (
    <div className="entirePage">
      ...
      <div className="centerPhotos">
        <div className="flickrPhotos">{photos}</div>
      </div>
    </div>
  );
}
