...
function Music() {
    const coverArts = import.meta.glob('../../../public/musicCovers/*.{png,jpg,jpeg}', { eager: true });
    ...
    function handleSongClick(artist_id, song_id) {
        ...
        setPlayingSongURL("http://192.168.1.204:808/stream/"+artist_id+"/"+song_id)
    }
    return (
            <div className="flex justify-center h-[80vh]">

                <div className="bg-white rounded-[10px] mt-14 relative px-4 z-1 w-[86vw]">
                    ...
                    <div className="flex justify-center border-2 border-blue">
                        {/*Display Artists*/}
                        {serverError ? "Sorry, the music server seems to be down at the moment": <></>}
                        <ul className="flex flex-col justify-center">
                            ...
                            <ArtistDisplay sendSelectedSong={handleSongClick} artist_list={artistList} />
